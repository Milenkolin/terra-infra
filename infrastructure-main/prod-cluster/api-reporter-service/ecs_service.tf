resource "aws_ecs_task_definition" "api_reporter_service" {
  family                   = "${data.terraform_remote_state.prod_cluster.outputs.environment}-api-reporter"
...
[
    {
      ...
      "logConfiguration": {
        ...
        "secretOptions": [],
        "options": {
          "awslogs-group": "prod-api-reporter",
...
resource "aws_ecs_service" "api_reporter_service" {
  name                               = "prod-api-reporter-service-Service-SCVuo5D17QNJ"
